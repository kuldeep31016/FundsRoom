...
const DEMO_ROLES: Array<{ role: Role; email: string; blurb: string; Icon: typeof IconCrown }> = [
  { role: 'ADMIN', email: 'admin@erpcrm.test', blurb: 'Full system access and administration', Icon: IconCrown },
  { role: 'SALES', email: 'sales@erpcrm.test', blurb: 'Manage customers, sales and challans', Icon: IconUsers },
  { role: 'WAREHOUSE', email: 'warehouse@erpcrm.test', blurb: 'Manage inventory, stock and dispatch', Icon: IconBox },
  { role: 'ACCOUNTS', email: 'accounts@erpcrm.test', blurb: 'View reports and financial data', Icon: IconReport },
];
      ...
      <div className="auth__inner">
        ...
        <section className="auth-card">
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <p className="auth-roles__hint">Select the portal you want to access</p>
